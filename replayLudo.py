...
class LudoApp():
    ...
    def nextStep(self, event):
        ...
        self.tempDrawnObj.append(self.c.create_text(200,20,fill="gray",font="Times 20 italic bold",
                        text="Player {}, Die {}, PieceChosen {}".format(playerI+1,die,pieceI+1)))
    ...
    def prevStep(self, event):
        ...
        # Draw new peices
        self.tempDrawnObj=[self.drawPlayer(self.drawPts[i][0,piece],self.drawPts[i][1,piece],j,i) for i,pieces in enumerate(playerPieces) for j,piece in enumerate(pieces)]
        self.tempDrawnObj.append(self.c.create_text(200,10,fill="gray",font="Times 20 italic bold",
                        text="Player {}, Die {}, PieceChosen {}".format(playerI+1,die,pieceI+1)))
